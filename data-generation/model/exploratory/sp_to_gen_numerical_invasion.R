...
#generalist invading specialist
...
gen_10 = 0.02
gen_50 = 0.1
start_density_0.001 <- c(E = 0.1, S = 0.1, gen = gen_0.001, sp = 0.1)
start_density_1 <- c(E = 0.1, S = 0.1, gen = gen_1, sp = 0.1)
start_density_10 <- c(E = 0.1, S = 0.1, gen = gen_10, sp = 0.1)
start_density_50 <- c(E = 0.1, S = 0.1, gen = gen_50, sp = 0.1)
maxcost = 5
